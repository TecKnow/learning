...
export const discounts  = ({fields}) => (
  ...
  {fields.map((code, index)=>(<div key={index} className="field-array-item">
    <Field name={code} type="text" component={customInputField} label={`Discount Code #${index+1 }`} autoFocus/>
